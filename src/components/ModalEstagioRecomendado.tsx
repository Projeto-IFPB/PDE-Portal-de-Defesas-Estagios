        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-md p-2.5 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 placeholder:text-gray-400 dark:placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-800"
            />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md py-2.5 pr-2.5 pl-9 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 placeholder:text-gray-400 dark:placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-800"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-300 rounded-md p-2.5 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 placeholder:text-gray-400 resize-none dark:placeholder:text-slate-400 dark:border-slate-600 dark:bg-slate-800"
            />
          </div>
