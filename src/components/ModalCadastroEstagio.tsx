...
export default function ModalEstagio({
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-md p-2.5 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 dark:text-slate-100 placeholder:text-gray-400 dark:placeholder:text-slate-400"
            />
          </div>
          <div className="flex flex-col">
            <label
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md py-2.5 pr-2.5 pl-9 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 dark:text-slate-100 placeholder:text-gray-400 dark:placeholder:text-slate-400"
              />
          ...
          <div className="flex flex-col">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md py-2.5 pr-2.5 pl-9 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 dark:text-slate-100"
              />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 mb-8">
          <div className="flex flex-col">
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-300 rounded-md p-2.5 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-gray-700 dark:text-slate-100 placeholder:text-gray-400 resize-none"
            />
          </div>
        </div>
      ...
      <div className="bg-gray-50/80 px-8 py-5 border-t border-gray-100 flex items-center justify-end gap-6 dark:bg-slate-900/50">
        <button
          onClick={fecharModal}
          disabled={isSubmitting}
